...
const createTripValidationSchema = (selectedVehicle) => {
  ...
  return Yup.object({
      ...
      .of(
        Yup.object({
          ...
          truckHireCost: Yup.number()
            .min(0, "Truck hire cost must be positive")
            .optional()
            .default(0),
          argestment: Yup.number()
            .min(0, "Argestment must be positive")
            .optional()
            .default(0),
    ...
    driver: isSelfOwned
      ? Yup.string().required("Driver is required")
      : Yup.string().optional(),
...
export function EnhancedEditTripDialog({
  open,
  onOpenChange,
  onSuccess,
  tripData,
  ...
  const getInitialValues = useCallback(() => {
    ...
    const initialValues = {
        ...
        tripData.clients?.length > 0
          ? tripData.clients.map((client) => ({
              ...
              loadDetails: {
                ...
                specialInstructions:
                  client.loadDetails?.specialInstructions || "",
              },
              origin: {
              ...
              loadDate: client.loadDate
                ? new Date(client.loadDate).toISOString().slice(0, 16)
                : new Date(),
            }))
          : [
              {
      ...
      vehicle:
        typeof tripData.vehicle === "object"
          ? tripData.vehicle._id
          : tripData.vehicle || "",
      driver:
      ...
      scheduledDate: tripData.scheduledDate
        ? new Date(tripData.scheduledDate).toISOString().slice(0, 16)
        : "",
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="min-w-[80vw] max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Update trip details, clients, and load information.
            </DialogDescription>
          </DialogHeader>
